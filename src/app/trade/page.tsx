  ...
  return (
    <div className=" w-1/2 mx-auto mt-20 text-xl animate-slideUp">
      ...
      <p>
        ...
        to experience virtual trading. Whether you&apos;re learning how trading
        works or just testing strategies, you&apos;ll have a virtual balance to
        practice buying and selling items. Stay tuned as we work to bring you
        features like:
      </p>
